...
vl_lables = QVBoxLayout()
vl_lables.addWidget(lb_quest)
vl_lables.addWidget(lb_right_ans)
vl_lables.addWidget(lb_wrong_ans1)
vl_lables.addWidget(lb_wrong_ans2)
vl_lables.addWidget(lb_wrong_ans3)
...
hl_question.addLayout(vl_lables)
